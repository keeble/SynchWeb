...
class Sample extends Page
{
        ...
        public static $arg_list = array('page' => '\d+',
                              ...
                              'SAMPLEGROUPID' => '\d+',
                              // Items added for Soft Condensed Matter
                              'EXPERIMENTTYPEID' => '\d+',
        ...
        function _prepare_sample_args($s=null) {
            ...
            foreach (array('CENTRINGMETHOD', 'EXPERIMENTKIND', 'RADIATIONSENSITIVITY', 'SCREENCOMPONENTGROUPID', 'BLSUBSAMPLEID', 'COMPONENTIDS', 'COMPONENTAMOUNTS',
                            'REQUIREDRESOLUTION', 'CELL_A', 'CELL_B', 'CELL_C', 'CELL_ALPHA', 'CELL_BETA', 'CELL_GAMMA', 'VOLUME', 'ABUNDANCE', 'PACKINGFRACTION',
                            'DIMENSION1', 'DIMENSION2', 'DIMENSION3', 'SHAPE', 'THEORETICALDENSITY', 'LOOPTYPE', 'ENERGY', 'USERPATH',
                            'EXPERIMENTTYPEID', 'PURIFICATIONCOLUMNID', 'ROBOTPLATETEMPERATURE', 'EXPOSURETEMPERATURE') as $f) {
