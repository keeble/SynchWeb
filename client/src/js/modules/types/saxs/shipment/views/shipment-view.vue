  ...
  <div class="content">
    ...
    >
      <template slot="content" slot-scope="{ row, rowIndex }">
        ...
        <td>
          <validation-provider v-if="isEditingRowIndex(rowIndex)" slim rules="numeric|min_value:1" v-slot="{ errors }">
            <base-input-select
    ...
    <!--
      ...
      Tailwind style - makes the Add Container button to be consistent with Add Dewar button
    -->
    <!-- 
