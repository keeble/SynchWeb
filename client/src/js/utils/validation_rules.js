...
// This allows this file to be used directly by vee-validate form components and to extend backbone validation rules
// It acts to map the string representation of backbone validation rules 'wwsdash' to expressions used by vee-validate
define([], function () {
  return {
    wwsdash: {
      regex: /^(\w|\s|\-)+$/,
