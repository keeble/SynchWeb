<template>
  <!--
  This is a wrapper around puck/plate graphics
  We only care about showing if the sample in each position is valid/invalid
  -->
...
<script>
import PlateView from 'modules/types/saxs/shipment/components/plate-view.vue'
import PuckView from 'modules/types/saxs/shipment/components/puck-view.vue'
